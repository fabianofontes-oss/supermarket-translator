...
export const ShoppingBagIconSolid: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
       <path d="M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l1.263 12c.07.658-.463 1.243-1.119 1.243H4.25a1.125 1.125 0 01-1.12-1.243l1.264-12A1.125 1.125 0 015.513 7.5h12.974c.576 0 1.059.435 1.119 1.007zM8.625 10.5a.375.375 0 11-.75 0 .375.375 0 01.75 0zm7.5 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
    </svg>
);
...
/** Alto-falante cortado: o aparelho não tem voz instalada no idioma do destino. */
...
export const StarIconSolid: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
...
export const FuelIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 9h3.75a2.25 2.25 0 0 1 2.25 2.25v9.75m-13.5-12h11.25c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125H7.5A2.25 2.25 0 0 1 5.25 19.5V5.25A2.25 2.25 0 0 1 7.5 3h6A2.25 2.25 0 0 1 15.75 5.25v3.75Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 13.5h3M9 16.5h3" />
    </svg>
);
...
export const PawIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 12.75c1.242 0 2.25 1.008 2.25 2.25h-4.5c0-1.242 1.008-2.25 2.25-2.25Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 6.75h.008v.008H8.25V6.75Zm2.25-2.25h.008v.008H10.5V4.5Zm3 0h.008v.008H13.5V4.5Zm2.25 2.25h.008v.008H15.75V6.75Z" />
    </svg>
);
...
export const PixIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3.75L4.5 12l7.5 8.25L19.5 12 12 3.75z" />
...
export const BarcodeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 4.5v15m3-15v15m2.25-15v15m3-15v15m2.25-15v15m3-15v15m2.25-15v15m3-15v15" />
    </svg>
);

/**
 * Bandeja com seta para cima. Chamava-se `ShareIcon` e nunca foi usado por
 * ninguém — o nome mentia: o desenho lê como enviar/baixar arquivo, não como
 * compartilhar. Nome honesto, para quem precisar dele um dia.
 */
...
/**
 * Compartilhar: três pontos ligados. É o glifo que Android e a web usam, e o
 * único que não se confunde com baixar ou enviar arquivo — uma caixa com seta
 * muda de significado conforme a direção da seta, e o usuário lê "download".
 */
...
export const BodyIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor" className={className}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.4v8m0 0-2.6 7m2.6-7 2.6 7M6.5 9.5 12 8l5.5 1.5" />
  </svg>
);
...
export const CafeIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor" className={className}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M17 10h1.5a2.5 2.5 0 0 1 0 5H17M3 21h15" />
  </svg>
);

export const PronounsIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor" className={className}>
