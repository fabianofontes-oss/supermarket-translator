...
//
// O QUE FALA DA ESPANHA SÓ APARECE NA ESPANHA. O destino pode ser EUA ou França, e
// uma brasileira em Nova York não pode ler "blush quase ninguém entende" embaixo da
// palavra "blush". Por isso o texto de explicação vive em dois campos:
//   • `descs`      → o que o produto É. Neutro, vale em qualquer destino. Há teste
//                    recusando "Espanha"/"espanhol" aqui, nos oito idiomas.
//   • `spainNote` e o `note` dos acessórios → a armadilha de NOME na Espanha. A
//                    tela só desenha com destino `es`.
...
export interface Product {
  ...
  /** O que o produto é, na língua de quem lê. Neutro: vale em qualquer destino. */
  descs: Text;
  /** Como se pede NA ESPANHA, na língua de quem lê. Só aparece com destino `es`. */
  spainNote?: Text;
}
...
export const MAKEUP_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    descs: { es: 'Fija el maquillaje y quita brillos.', pt: 'Fixa a maquiagem e tira o brilho.', en: 'Sets makeup and removes shine.', fr: 'Fixe le maquillage et matifie.', it: 'Fissa il trucco e opacizza.', uk: 'Закріплює макіяж і прибирає блиск.', lt: 'Fiksuoja makiažą ir slopina blizgesį.', ar: 'تثبّت المكياج وتزيل اللمعان.' },
    spainNote: { es: 'En España se pide en plural: "unos polvos".', pt: 'Na Espanha se pede no plural: "unos polvos".', en: 'In Spain you ask for it in the plural: "unos polvos".', fr: 'En Espagne, on le demande au pluriel : "unos polvos".', it: 'In Spagna si chiede al plurale: "unos polvos".', uk: 'В Іспанії просять у множині: "unos polvos".', lt: 'Ispanijoje prašoma daugiskaita: "unos polvos".', ar: 'في إسبانيا تُطلب بصيغة الجمع: "unos polvos".' },
  },
  {
    ...
    descs: { es: 'Color para las mejillas.', pt: 'Cor para as maçãs do rosto.', en: 'Colour for the cheeks.', fr: 'Couleur pour les joues.', it: 'Colore per le guance.', uk: 'Колір для щік.', lt: 'Spalva skruostams.', ar: 'لون للخدود.' },
    spainNote: { es: 'En España se dice "colorete".', pt: 'Na Espanha é "colorete". "Rubor" não se usa, e "blush" quase ninguém entende.', en: 'In Spain it is "colorete". Few people there understand "blush".', fr: 'En Espagne, on dit "colorete".', it: 'In Spagna si dice "colorete".', uk: 'В Іспанії кажуть "colorete".', lt: 'Ispanijoje sakoma "colorete".', ar: 'في إسبانيا يقال "colorete".' },
  },
  {
    ...
    descs: { es: 'Color para los labios.', pt: 'Cor para os lábios.', en: 'Colour for the lips.', fr: 'Couleur pour les lèvres.', it: 'Colore per le labbra.', uk: 'Колір для губ.', lt: 'Spalva lūpoms.', ar: 'لون للشفاه.' },
    spainNote: { es: 'En España también se dice "barra de labios".', pt: 'Na Espanha é "pintalabios" ou "barra de labios". "Labial" sozinho não se usa.', en: 'In Spain: "pintalabios" or "barra de labios".', fr: 'En Espagne : "pintalabios" ou "barra de labios".', it: 'In Spagna: "pintalabios" o "barra de labios".', uk: 'В Іспанії: "pintalabios" або "barra de labios".', lt: 'Ispanijoje: "pintalabios" arba "barra de labios".', ar: 'في إسبانيا: "pintalabios" أو "barra de labios".' },
  },
  {
    ...
    descs: { es: 'Para las pestañas.', pt: 'Para os cílios.', en: 'For the eyelashes.', fr: 'Pour les cils.', it: 'Per le ciglia.', uk: 'Для вій.', lt: 'Blakstienoms.', ar: 'للرموش.' },
    spainNote: { es: 'En España se dice "rímel", no "máscara".', pt: 'Na Espanha se diz "rímel". "Máscara de pestañas" existe, mas no balcão é "rímel".', en: 'In Spain it is called "rímel".', fr: 'En Espagne, on dit "rímel".', it: 'In Spagna si dice "rímel".', uk: 'В Іспанії кажуть "rímel".', lt: 'Ispanijoje sakoma "rímel".', ar: 'في إسبانيا يقال "rímel".' },
  },
  {
  ...
  },
  {
    ...
    agree: { es: 'm', pt: 'm', en: 'm', fr: 'm', it: 'm', uk: 'm', lt: 'm', ar: 'm' },
    descs: { es: 'Color para las uñas.', pt: 'Cor para as unhas.', en: 'Colour for the nails.', fr: 'Couleur pour les ongles.', it: 'Colore per le unghie.', uk: 'Колір для нігтів.', lt: 'Spalva nagams.', ar: 'لون للأظافر.' },
    spainNote: { es: 'En España también se dice "pintaúñas".', pt: 'Na Espanha também se diz "pintaúñas".', en: 'In Spain it is also called "pintaúñas".', fr: 'En Espagne, on dit aussi "pintaúñas".', it: 'In Spagna si dice anche "pintaúñas".', uk: 'В Іспанії кажуть також "pintaúñas".', lt: 'Ispanijoje dar sakoma "pintaúñas".', ar: 'في إسبانيا يقال أيضًا "pintaúñas".' },
  },
];
...
export const DIMENSIONS: Dimension[] = [
  ...
  },
  {
    ...
    options: [
      { key: 'frio',
        labels: { es: 'Frío', pt: 'Frio (fundo rosado)', en: 'Cool', fr: 'Froid', it: 'Freddo', uk: 'Холодний', lt: 'Šaltas', ar: 'بارد' },
      ...
      { key: 'calido',
        labels: { es: 'Cálido', pt: 'Quente (fundo amarelado)', en: 'Warm', fr: 'Chaud', it: 'Caldo', uk: 'Теплий', lt: 'Šiltas', ar: 'دافئ' },
  ...
  },
  {
    ...
    options: [
      { key: 'ligera',
        labels: { es: 'Ligera', pt: 'Leve (disfarça pouco)', en: 'Light', fr: 'Légère', it: 'Leggera', uk: 'Легке', lt: 'Lengvas', ar: 'خفيفة' },
      ...
      { key: 'alta',
        labels: { es: 'Alta', pt: 'Alta (cobre manchas)', en: 'Full', fr: 'Élevée', it: 'Alta', uk: 'Високе', lt: 'Didelis', ar: 'عالية' },
  ...
  },
  {
    ...
    options: [
      { key: 'mate',
        labels: { es: 'Mate', pt: 'Matte (sem brilho)', en: 'Matte', fr: 'Mat', it: 'Opaco', uk: 'Матовий', lt: 'Matinis', ar: 'مطفي' },
      ...
      { key: 'satinado',
        labels: { es: 'Satinado', pt: 'Acetinado (brilho leve)', en: 'Satin', fr: 'Satiné', it: 'Satinato', uk: 'Сатиновий', lt: 'Satininis', ar: 'ساتان' },
...
export interface Tool {
  ...
  /** Armadilha de nome NA ESPANHA, na língua de quem lê. Toda nota daqui fala do
   *  espanhol da Espanha, e por isso a tela só a desenha com destino `es` — e a
   *  desenha no cartão fixo da frase, onde ela está olhando quando toca. */
  note?: Text;
}
...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    num: { uk: 'pl', lt: 'pl' },
    note: { es: 'En España se llama "rizador", de "rizar".', pt: 'Em espanhol é "rizador", de "rizar" (fazer cachos). Não lembra "curvador", e é uma das palavras que mais travam na loja.', en: 'Spanish calls it "rizador", from "rizar" (to curl).', fr: 'En espagnol : "rizador", de "rizar" (boucler).', it: 'In spagnolo "rizador", da "rizar" (arricciare).', uk: 'Іспанською "rizador", від "rizar" — підкручувати.', lt: 'Ispaniškai "rizador", nuo "rizar" — garbanoti.', ar: 'بالإسبانية "rizador"، من "rizar" أي يجعّد.' },
  },
  {
  ...
  },
  {
    ...
    num: { es: 'pl', pt: 'pl', en: 'pl', fr: 'pl', it: 'pl', uk: 'pl', lt: 'pl', ar: 'pl' },
    note: { es: 'En España son "bastoncillos".', pt: 'Na Espanha é "bastoncillos". "Cotonete" é marca do Brasil, e lá ninguém entende.', en: 'Spain says "bastoncillos".', fr: 'En Espagne : "bastoncillos".', it: 'In Spagna si dice "bastoncillos".', uk: 'В Іспанії — "bastoncillos".', lt: 'Ispanijoje — "bastoncillos".', ar: 'في إسبانيا تسمى "bastoncillos".' },
  },
  {
  ...
  },
  {
    ...
    note: { es: 'En España es "neceser".', pt: 'Na Espanha é "neceser". Parece "nécessaire", mas se escreve e se fala diferente.', en: 'Spain says "neceser".', fr: 'En Espagne : "neceser".', it: 'In Spagna si dice "neceser".', uk: 'В Іспанії — "neceser".', lt: 'Ispanijoje — "neceser".', ar: 'في إسبانيا تسمى "neceser".' },
  },
  {
