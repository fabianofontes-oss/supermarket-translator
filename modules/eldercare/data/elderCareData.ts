...
export const CARE_TOOLS: CareTool[] = [
  ...
  },
  {
    ...
    note: {
      ...
      uk: 'Судно і пелюшку купують в аптеці, на прилавку й без рецепта.',
      lt: 'Basonas ir paklotas perkami vaistinėje, prie prekystalio ir be recepto.',
      ar: 'تُشترى القصرية وواقي الفراش من الصيدلية مباشرة ودون وصفة طبية.',
    },
  },
  {
    key: 'pad', group: 'bed',
    ...
    note: {
      ...
      uk: 'В аптеці кажуть «el absorbente», а не «pañal» — останнє асоціюється з немовлям. Просять за розміром (talla) і за вбирністю — día, noche, súper — і ніколи за маркою.',
      lt: 'Vaistinėje sakoma „el absorbente“, ne „pañal“, kuris primena kūdikį. Prašoma pagal dydį (talla) ir sugeriamumą – día, noche, súper – niekada pagal prekės ženklą.',
      ar: 'في الصيدلية الكلمة هي «el absorbente» لا «pañal» التي توحي بالرضيع. ويُطلب بالمقاس (talla) وبدرجة الامتصاص — día, noche, súper — لا بالعلامة التجارية.',
    },
  },
  {
