...
describe('hub', () => {
  it('Supermercado e Farmácia aparecem, mas desativados', () => {
    render(<App />);
    expect(ladrilho('supermarketGuide').disabled).toBe(true);
    expect(ladrilho('modulePharmacy').disabled).toBe(true);
...
describe('painel de idiomas', () => {
  const abrirPainel = async () => {
    ...
    render(<App />);
    await user.click(screen.getByRole('button', { name: t('languageSettings') }));
